...
namespace Arcanoid
{
    ...
    FillEllipse(ballBrush, ball);
                ...
                //string help = "←/→ или мышь — движение | Пробел — отпустить шар | P — пауза | R — рестарт | Esc — выход";
                //g.DrawString(help, new Font("Arial", 9), Brushes.LightGray, new PointF(8, ClientSize.Height - 45));
            }
